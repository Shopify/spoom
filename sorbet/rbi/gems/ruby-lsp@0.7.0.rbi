...
class RubyLsp::Executor
  ...
  # source://ruby-lsp/lib/ruby_lsp/executor.rb#339
  ...
  # source://ruby-lsp/lib/ruby_lsp/executor.rb#397
  sig do
    params(
      uri: ::String,
      position: {line: ::Integer, character: ::Integer}
  ...
  # source://ruby-lsp/lib/ruby_lsp/executor.rb#180
  sig do
    params(
      uri: ::String,
      position: {line: ::Integer, character: ::Integer}
  ...
  # source://ruby-lsp/lib/ruby_lsp/executor.rb#369
  ...
  # source://ruby-lsp/lib/ruby_lsp/executor.rb#205
  sig do
    params(
      uri: ::String,
      position: {line: ::Integer, character: ::Integer}
  ...
  # source://ruby-lsp/lib/ruby_lsp/executor.rb#439
  sig do
    params(
  ...
  # source://ruby-lsp/lib/ruby_lsp/executor.rb#290
  sig do
    params(
      uri: ::String,
      position: {line: ::Integer, character: ::Integer},
  ...
  # source://ruby-lsp/lib/ruby_lsp/executor.rb#378
  sig do
    params(
      uri: ::String,
      range: {start: {line: ::Integer, character: ::Integer}, end: {line: ::Integer, character: ::Integer}}
  ...
  # source://ruby-lsp/lib/ruby_lsp/executor.rb#228
  sig do
    params(
      uri: ::String,
  ...
  # source://ruby-lsp/lib/ruby_lsp/executor.rb#234
  ...
  sig { params(uri: ::String).returns(::Object) }
  def text_document_did_save(uri); end
end
...
class RubyLsp::Requests::CodeLens < ::RubyLsp::Listener
  ...
  # source://ruby-lsp/lib/ruby_lsp/requests/code_lens.rb#96
  sig { params(node: ::SyntaxTree::ClassDeclaration).void }
  def after_class(node); end

  # source://ruby-lsp/lib/ruby_lsp/requests/code_lens.rb#135
  sig { params(node: ::SyntaxTree::Command).void }
  def after_command(node); end

  # source://ruby-lsp/lib/ruby_lsp/requests/code_lens.rb#73
  sig { void }
  def merge_external_listeners_responses!; end

  # source://ruby-lsp/lib/ruby_lsp/requests/code_lens.rb#170
  sig { params(other: RubyLsp::Listener[ResponseType]).returns(T.self_type) }
  def merge_response!(other); end

  # source://ruby-lsp/lib/ruby_lsp/requests/code_lens.rb#141
  sig { params(node: ::SyntaxTree::CallNode).void }
  def on_call(node); end

  # source://ruby-lsp/lib/ruby_lsp/requests/code_lens.rb#80
  sig { params(node: ::SyntaxTree::ClassDeclaration).void }
  ...
  # source://ruby-lsp/lib/ruby_lsp/requests/code_lens.rb#102
  ...
  # source://ruby-lsp/lib/ruby_lsp/requests/code_lens.rb#66
  sig { void }
  def register_external_listeners!; end
  ...
  # source://ruby-lsp/lib/ruby_lsp/requests/code_lens.rb#220
...
# source://ruby-lsp/lib/ruby_lsp/requests/document_save.rb#6
class RubyLsp::Requests::DocumentSave < ::RubyLsp::Listener
  extend T::Generic

  ResponseType = type_member { { fixed: T.untyped } }

  # source://ruby-lsp/lib/ruby_lsp/requests/document_save.rb#20
  sig { params(emitter: ::RubyLsp::EventEmitter, message_queue: ::Thread::Queue).void }
  def initialize(emitter, message_queue); end

  # source://ruby-lsp/lib/ruby_lsp/requests/document_save.rb#12
  sig { override.returns(ResponseType) }
  def response; end
end
...
class RubyLsp::Requests::Hover < ::RubyLsp::Listener
  ...
  # source://ruby-lsp/lib/ruby_lsp/requests/hover.rb#50
  sig { void }
  def register_external_listeners!; end
  ...
  # source://ruby-lsp/lib/ruby_lsp/requests/hover.rb#100
  sig do
    params(
      name: ::String,
      node: ::SyntaxTree::Node
...
# source://ruby-lsp/lib/ruby_lsp/requests.rb#47
...
RubyLsp::Requests::Support::RailsDocumentClient::RAILTIES_VERSION = T.let(T.unsafe(nil), T.untyped)
...
class RubyLsp::Server
  ...
  # source://ruby-lsp/lib/ruby_lsp/server.rb#119
  sig { returns(::Thread) }
  def new_worker; end
