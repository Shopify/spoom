...
class ANSI::ProgressBar
  ...
  # source://ansi//lib/ansi/progressbar.rb#57
  ...
  #
  # source://ansi//lib/ansi/progressbar.rb#91
  ...
  # source://ansi//lib/ansi/progressbar.rb#58
  def mark=(mark); end
...
class ANSI::String
  ...
  # slice
  #
  # source://ansi//lib/ansi/string.rb#132
  def [](*args); end
  ...
  # source://ansi//lib/ansi/string.rb#201
  def color(code); end

  # source://ansi//lib/ansi/string.rb#209
  def color!(code); end
  ...
  #
  # source://ansi//lib/ansi/string.rb#59
  def to_str; end
