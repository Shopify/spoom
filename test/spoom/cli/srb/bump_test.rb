    ...
    module Srb
      class BumpTest < TestWithProject
        ...
        def test_bump_doesnt_change_sigils_outside_directory
          ...
          result = @project.spoom("srb bump --no-color lib/b")
          assert_empty(result.err)
          assert_equal(<<~OUT, result.out)
            Checking files...
        ...
        def test_bump_nondefault_from_to_complete
          ...
          result = @project.spoom("srb bump --no-color --from true --to strict")
          assert_empty(result.err)
          assert_equal(<<~OUT, result.out)
            Checking files...
        ...
        def test_bump_nondefault_from_to_revert
          ...
          result = @project.spoom("srb bump --no-color --from ignore --to strong")
          assert_empty(result.err)
          assert_equal(<<~OUT, result.out)
            Checking files...
        ...
        def test_force_bump_without_typecheck
          ...
          result = @project.spoom("srb bump --no-color --force --from ignore --to strong")
          assert_empty(result.err)
          assert_equal(<<~OUT, result.out)
            Checking files...
        ...
        def test_bump_dry_does_nothing
          ...
          result = @project.spoom("srb bump --no-color --dry")
          assert_empty(result.err)
          assert_equal(<<~OUT, result.out)
            Checking files...
        ...
        def test_bump_dry_does_nothing_even_with_force
          ...
          result = @project.spoom("srb bump --no-color --dry -f")
          assert_empty(result.err)
          assert_equal(<<~OUT, result.out)
            Checking files...
        ...
        def test_bump_dry_suggest_custom_command
          ...
          result = @project.spoom("srb bump --no-color --dry -f --suggest-bump-command 'bump.sh'")
          assert_empty(result.err)
          assert_equal(<<~OUT, result.out)
            Checking files...
        ...
        def test_bump_dry_does_not_revert_files_not_bumped
          ...
          result = @project.spoom("srb bump --no-color --from false --to true --dry")
          assert_empty(result.err)
          assert_equal(<<~OUT, result.out)
            Checking files...
        ...
        def test_bump_only_specified_files
          ...
          result = @project.spoom("srb bump --no-color -o files.lst")
          assert_empty(result.err)
          assert_equal(<<~OUT, result.out)
            Checking files...
        ...
        def test_count_errors_without_dry
          ...
          result = @project.spoom("srb bump --no-color --count-errors")
          assert_empty(result.out)
        ...
        def test_bump_count_errors
          ...
          result = @project.spoom("srb bump --no-color --count-errors --dry")
          assert_empty(result.err)
          assert_equal(<<~OUT, result.out)
            Checking files...
        ...
        def test_bump_display_sorbet_error
          @project.write!("file.rb", <<~RB)
            # typed: false
          RB
          result = @project.spoom("srb bump --no-color --sorbet-options=\"--not-found\"")
        ...
        def test_multiple_constant_definitions
          ...
          result = @project.spoom("srb bump --no-color --from ignore --to false")
          assert_empty(result.err)
          assert_equal(<<~OUT, result.out)
            Checking files...
        ...
        def test_invalid_bump_with_rubocop_on_sigil
          ...
          result = @project.spoom("srb bump --no-color --from false --to true")
          assert_empty(result.err)
          assert_equal(<<~OUT, result.out)
            Checking files...
        ...
        def test_deprecated_bump_command
