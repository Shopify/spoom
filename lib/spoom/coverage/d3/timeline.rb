...
module Spoom
  module Coverage
    module D3
      ...
      class TimelineVersions < Timeline
        extend T::Sig
      ...
      class TimelineRuntimes < Timeline
        extend T::Sig
      ...
      class TimelineStacked < Timeline
        extend T::Sig
        extend T::Helpers
      ...
      class TimelineSigils < TimelineStacked
        extend T::Sig
      ...
      class TimelineCalls < TimelineStacked
        extend T::Sig
      ...
      class TimelineSigs < TimelineStacked
        extend T::Sig
